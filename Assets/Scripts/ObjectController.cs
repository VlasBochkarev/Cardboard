...
public class ObjectController : MonoBehaviour
{
    ...
    // across).
    private const float _minObjectDistance = 350.5f;
    private const float _maxObjectDistance = 650.5f;
    private const float _minObjectHeight = 30.5f;
    private const float _maxObjectHeight = 50.5f;
    ...
    public void TeleportRandomly()
    {
        ...
        XRRig.transform.position = new Vector3(prevPos.x, prevPos.y, prevPos.z);
